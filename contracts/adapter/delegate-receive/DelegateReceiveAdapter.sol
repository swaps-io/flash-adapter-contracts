...
import {IDelegateReceiveAdapter, IOrderReceiver} from "./interfaces/IDelegateReceiveAdapter.sol";
...
contract DelegateReceiveAdapter is IDelegateReceiveAdapter {
    ...
    function receiveDelegateAsset(IERC20 token_, uint256 amount_, uint256 minBalanceAfter_, bytes32 orderHash_, address resolver_, bytes calldata resolverData_) external {
        ...
        Address.functionCall(resolver_, resolverData_);
